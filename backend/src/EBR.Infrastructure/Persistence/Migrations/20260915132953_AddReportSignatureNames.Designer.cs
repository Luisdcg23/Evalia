...
namespace EBR.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260915132953_AddReportSignatureNames")]
    partial class AddReportSignatureNames
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EBR.Domain.Evaluations.EvaluationReport", b =>
                {
                    ...
                    b.ToTable("Evaluacion_Informe", null, t =>
                        {
                            t.HasCheckConstraint("CK_Evaluacion_Informe_Firma", "char_length(firma_nombre) > 0");
                        });
                });
            ...
            modelBuilder.Entity("EBR.Domain.Evaluations.EvaluationReportReview", b =>
                {
                    ...
                    b.ToTable("Evaluacion_Informe_Revision", null, t =>
                        {
                            t.HasCheckConstraint("CK_Evaluacion_Informe_Revision_Firma", "(decision = 'APPROVED' AND char_length(firma_nombre) > 0) OR (decision <> 'APPROVED' AND firma_nombre IS NULL)");
                        });
                });
